...
set(PKG_DEPENDS_NATIVE "yasm")
set(PKG_DEPENDS_TARGET "yasm-native")
set(PKG_TOOLCHAIN "cmake")
set(PKG_PATCHES "01-disable-executables.patch"
                "02-fix-gas-preprocessor-with-ccache.patch")

set(PKG_CMAKE_OPTS_NATIVE "-DCMAKE_ASM_NASM_COMPILER=${INSTALL_PREFIX_NATIVE}/bin/yasm"
                          "-DENABLE_SHARED=OFF"
                          "-DWITH_JPEG8=ON")

set(PKG_CMAKE_OPTS_TARGET ${PKG_CMAKE_OPTS_NATIVE})
