...
set(PKG_DEPENDS_NATIVE "libdvdread")
set(PKG_DEPENDS_TARGET "libdvdread")
set(PKG_TOOLCHAIN "autotools")
set(PKG_AUTORECONF ON)

set(PKG_BUILD_CFLAGS_NATIVE "-D_XBMC -DHAVE_DVDCSS_DVDCSS_H")

if(CORE_SYSTEM_NAME STREQUAL osx OR CORE_SYSTEM_NAME STREQUAL darwin_embedded)
  list(APPEND PKG_BUILD_CFLAGS_NATIVE "-D__DARWIN__")
endif()

set(PKG_BUILD_CFLAGS_TARGET "${PKG_BUILD_CFLAGS_NATIVE}")

set(PKG_CONFIGURE_OPTS_SHARED "--disable-shared"
                              "--enable-static"
                              "--with-pic")

set(PKG_CONFIGURE_OPTS_NATIVE "DVDREAD_LIBS=${INSTALL_PREFIX_NATIVE}/lib/libdvdread.la"
                              "DVDREAD_CFLAGS=-I${INSTALL_PREFIX_NATIVE}/include"
