...
set(PKG_CONFIGURE_OPTS_NATIVE "--prefix=${INSTALL_PREFIX_NATIVE}"
                              ${PKG_CONFIGURE_OPTS_SHARED})

if(ENABLE_CCACHE AND CCACHE_PROGRAM)
  list(APPEND PKG_CONFIGURE_OPTS_NATIVE "--cc=${CCACHE_PROGRAM} ${CMAKE_C_COMPILER}"
...
if(WITH_FFMPEG_OPTIONS)
  list(APPEND PKG_CONFIGURE_OPTS_NATIVE "${WITH_FFMPEG_OPTIONS}")
...
set(PKG_CONFIGURE_COMMAND_NATIVE PKG_CONFIG_PATH=${INSTALL_PREFIX_NATIVE}/lib/pkgconfig ./configure ${PKG_CONFIGURE_OPTS_NATIVE})
set(PKG_BUILD_COMMAND_NATIVE $(MAKE))
set(PKG_INSTALL_COMMAND_NATIVE $(MAKE) install)
