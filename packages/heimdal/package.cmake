...
set(PKG_CONFIGURE_OPTS_NATIVE "ac_cv_prog_COMPILE_ET=no"
                              "--disable-shared"
                              "--without-openldap"
                              "--without-capng"
                              "--without-sqlite3"
...
set(PKG_POST_INSTALL_COMMAND_NATIVE "install -v lib/asn1/asn1_compile ${INSTALL_PREFIX_NATIVE}/bin"
                                    "install -v lib/com_err/compile_et ${INSTALL_PREFIX_NATIVE}/bin")
