...
if(CORE_PLATFORM_NAME_LC IN_LIST VALID_LINUX_PLATFORMS_LIST)
  include(cmake/platform/linux/Configuration.cmake)
else()
  include(cmake/platform/${CORE_PLATFORM_NAME_LC}/Configuration.cmake)
endif()
...
set(PLATFORM_LDFLAGS "-L${INSTALL_PREFIX_TARGET}/lib ${WITH_TARGET_LDFLAGS}" CACHE STRING "" FORCE)
